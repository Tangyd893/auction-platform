...
export default function RegisterPage() {
  const [form, setForm] = useState({ username: '', password: '', confirmPassword: '', email: '', role: 'buyer' })
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
        ...
        <form onSubmit={(e) => { e.preventDefault(); setError(''); registerMutation.mutate() }} className="space-y-4">
          <div>
